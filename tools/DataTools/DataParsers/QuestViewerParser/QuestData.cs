...
namespace AionQuests
{
    ...
    public partial class QuestFile
    {
        [XmlElement("HtmlPage", Form = XmlSchemaForm.Unqualified)]
        public List<HtmlPage> HtmlPages;
    ...
    public partial class HtmlPage
    {
        ...
        public static HtmlPageIndex Index { get; set; }

        [XmlIgnore]
        public int HtmlPageId {
            get {
                if (Index == null)
                    return -1;
                string checkName;
                if (name == "user_item_ok")
                    checkName = "check_user_item_ok";
                else if (name == "user_item_fail")
                    checkName = "check_user_item_fail";
                else
                    checkName = name;
                return Index[checkName];
            }
        }
    ...
    public partial class SelectsAct
    {
        ...
        public static HyperLinkIndex Index { get; set; }
        ...
        public int Id {
            get {
                if (Index == null)
                    return -1;
                return Index[String.Format("HACTION_{0}", ActionName.ToUpperInvariant())];
            }
        }
